...
public class Principal {
	 ...
	 */
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
                                    Principal window = new Principal(DataBase, query);
	 ...
	 */
	public Principal(GraphDatabaseService DataBase, Queries query) {
	 ...
	 */
	private void initialize(GraphDatabaseService DB, Queries query) {
		frame = new JFrame();
		...
		frame1.getContentPane().add(fondo);
                ...
                JLabel mostrarG = new JLabel (gustos);
                mostrarG.setHorizontalAlignment(SwingConstants.CENTER);
                mostrarG.setForeground(Color.WHITE);
                mostrarG.setFont(new Font ("Arial Narrow", Font.PLAIN, 30));
                mostrarG.setBounds(358, 581, 250, 28);
                frame.getContentPane().add(mostrarG);
                
                JLabel mostrarGustos = new JLabel(gustos);
		mostrarGustos.setHorizontalAlignment(SwingConstants.CENTER);
		mostrarGustos.setForeground(Color.CYAN);
